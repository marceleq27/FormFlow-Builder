      ...
      ...(contentType === "answer" ? [
        ...
        ...(answerType === "currency" ? [{
          ...
          options: [
            ...
            { option: "CAD", label: "Canadian Dollar (CAD)" },
            { option: "AUD", label: "Australian Dollar (AUD)" },
            { option: "CHF", label: "Swiss Franc (CHF)" },
            { option: "CNY", label: "Chinese Yuan (CNY)" },
            { option: "INR", label: "Indian Rupee (INR)" },
            { option: "MXN", label: "Mexican Peso (MXN)" },
          ],
